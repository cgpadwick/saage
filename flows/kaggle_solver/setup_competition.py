...
EXCLUDES = [
    ...
    "batch/",            # batched-flow round results (patches, summaries) —
    "batch_done.marker", # a revert's `git clean -fd` must never eat them
    "autoresearch_ideas.*",   # the researcher's idea menu survives reverts
]
