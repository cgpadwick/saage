...
| competition | flow | medal | above median | val | test | LLM cost | GPU h | run |
|---|---|---|---|---|---|---|---|---|
| spooky-author-identification | **MLE-STAR³** | none | **yes** | 0.3332 | **0.3481** | $5.66 | 10.6 | `…1824-759b` |
| spooky-author-identification | flat | none | **yes** | 0.3985 | 0.4129 | $2.24 | 2.4 | `…1603-dc9a` |
| nomad2018-transparent-conductors | flat | none | no² | 0.0518 | 0.1424 | $7.26 | 5.7 | `…1603-d093` |
| spooky-author-identification | flat | ungraded¹ | — | 0.3207 | — | $4.95 | 10.2 | `…0425-fdc6` |

All runs: deepseek-v4-flash on a single Lambda A10 ($1.29/hr).
